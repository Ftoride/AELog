...
class SettingsDialog(QDialog):
    def __init__(self, parent, current_log, current_interval):
    ...
    def get_values(self):
        return self.log_path_edit.text(), self.interval_spin.value()
...
class MainWindow(QWidget):
    ...
    def open_settings_dialog(self):
        dlg = SettingsDialog(self, self.log_path_edit.text(), self.interval_spin.value())
        if dlg.exec_():
            log_path, interval = dlg.get_values()
